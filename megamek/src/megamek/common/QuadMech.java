...
public class QuadMech extends Mech {
    ...
    public HitData rollHitLocation(int table, int side, int aimedLocation, AimingMode aimingMode,
      ...
      if (isCritical) {
                    ...
                    switch (roll) {
                        case 2:
                            if ((getCrew().hasEdgeRemaining()
                                ...
                                HitData result = rollHitLocation(table, side, aimedLocation, aimingMode, cover, attackerId, false);
                                result.setUndoneLocation(tac(table, side, Mech.LOC_CT, cover, false, attackerId, false));
                                return result;
                            }
                            return tac(table, side, Mech.LOC_CT, cover, false, attackerId, true);
                        case 3:
                    ...
                    switch (roll) {
                        case 2:
                            if ((getCrew().hasEdgeRemaining()
                                ...
                                getCrew().decreaseEdge();
                                HitData result = rollHitLocation(table, side, aimedLocation, aimingMode, cover, attackerId, false);
                                result.setUndoneLocation(tac(table, side, Mech.LOC_CT, cover, true, attackerId, false));
                                return result;
                            }
                            return tac(table, side, Mech.LOC_CT, cover, true, attackerId, true);
                        case 3:
                    ...
                    switch (roll) {
                        case 2:
                            if ((getCrew().hasEdgeRemaining()
                                ...
                                getCrew().decreaseEdge();
                                HitData result = rollHitLocation(table, side, aimedLocation, aimingMode, cover, attackerId, false);
                                result.setUndoneLocation(tac(table, side, Mech.LOC_LT, cover, false, attackerId, false));
                                return result;
                            }
                            return tac(table, side, Mech.LOC_LT, cover, false, attackerId, true);
                        case 3:
                            return new HitData(Mech.LOC_RARM);
                        case 4:
                        case 5:
                    ...
                    switch (roll) {
                        case 2:
                            if ((getCrew().hasEdgeRemaining()
                                ...
                                getCrew().decreaseEdge();
                                HitData result = rollHitLocation(table, side, aimedLocation, aimingMode, cover, attackerId, false);
                                result.setUndoneLocation(tac(table, side, Mech.LOC_RT, cover, false, attackerId, false));
                                return result;
                            }
                            return tac(table, side, Mech.LOC_RT, cover, false, attackerId, true);
                        case 3:
                            return new HitData(Mech.LOC_LARM);
                        case 4:
                        case 5:
        ...
        return super.rollHitLocation(table, side, aimedLocation, aimingMode, cover, attackerId, false);
    }
