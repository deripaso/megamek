...
public class AreaEffectHelper {
    ...
    public static void artilleryDamageEntity(Entity entity, int damage, Building bldg, int bldgAbsorbs,
        ...
        if (entity instanceof BattleArmor) {
            ...
            while (hits > 0) {
                ...
                HitData hit = entity.rollHitLocation(toHit.getHitTable(), toHit.getSideTable(), killer.getId(),false);
    ...
    public static void applyExplosionClusterDamageToEntity(Entity entity, int damage, int clusterAmt,
        ...
        while (damage > 0) {
            ...
            HitData hit = entity.rollHitLocation(table, Compute.targetSideTable(position, entity), entity.getId(), false); //TODO - check
